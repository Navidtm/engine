...
import type { MeshHandle, QuaternionControl, Vector3Control } from "./engine/engine-types.js";
import { validateFiniteTuple, validateQuaternion } from "./engine/engine-validation.js";
