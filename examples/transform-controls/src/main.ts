...
if (canvas === null || slider === null || output === null) throw new Error("Example markup is incomplete.");
...
await engine.init(); engine.start(); output.textContent = "Move the cube with the slider.";
